...
Private Sub cmdOK_Click()
    ...
    If chkToolbar.Value = vbChecked Then
        Project.Toolbars = SrcProject.Toolbars
    End If
            ...
            If Left(sLine, 3) = "[G]" And cmbGrps.ListIndex > 0 Then
                If Mid(GetParam(sLine, 1), 4) = cmbGrps.Text Then
                    ...
                    For i = 1 To UBound(MenuGrps) - 1
                        ...
                        MenuGrps(i).DropShadowColor = MenuGrps(UBound(MenuGrps)).DropShadowColor
                        MenuGrps(i).DropShadowSize = MenuGrps(UBound(MenuGrps)).DropShadowSize
